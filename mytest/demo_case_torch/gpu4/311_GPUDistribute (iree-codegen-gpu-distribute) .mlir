...
func.func @main_dispatch_0_matmul_1x3x4_f32() {
  ...
  %subview_2 = memref.subview %1[0, %workgroup_id_x] [4, 1] [1, 1] : memref<4x3xf32, #hal.descriptor_type<storage_buffer>> to memref<4x1xf32, strided<[3, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>
  %4 = vector.transfer_read %0[%c0_0, %c0_0], %cst_1 {in_bounds = [true, true]} : memref<1x4xf32, #hal.descriptor_type<storage_buffer>>, vector<1x4xf32>
  %5 = vector.transfer_read %subview_2[%c0_0, %c0_0], %cst_1 {in_bounds = [true, true]} : memref<4x1xf32, strided<[3, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>, vector<4x1xf32>
  ...
  %subview_3 = memref.subview %2[0, %workgroup_id_x] [1, 1] [1, 1] : memref<1x3xf32, strided<[3, 1], offset: 16>, #hal.descriptor_type<storage_buffer>> to memref<1x1xf32, strided<[3, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>
  %7 = vector.transfer_read %subview_3[%c0_0, %c0_0], %cst_1 {in_bounds = [true, true]} : memref<1x1xf32, strided<[3, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>, vector<1x1xf32>
  ...
  vector.transfer_write %10, %subview[%c0_0, %c0_0] {in_bounds = [true, true]} : vector<1x1xf32>, memref<1x1xf32, strided<[3, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>
  return
}
