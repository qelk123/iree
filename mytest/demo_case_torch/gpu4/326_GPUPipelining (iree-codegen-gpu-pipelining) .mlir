...
func.func @main_dispatch_0_matmul_1x3x4_f32() {
  ...
  %5 = vector.transfer_read %1[%c0, %workgroup_id_x], %cst_0 {in_bounds = [true, true]} : memref<4x3xf32, #hal.descriptor_type<storage_buffer>>, vector<4x1xf32>
  ...
  %7 = vector.transfer_read %2[%c0, %workgroup_id_x], %cst_0 {in_bounds = [true, true]} : memref<1x3xf32, strided<[3, 1], offset: 16>, #hal.descriptor_type<storage_buffer>>, vector<1x1xf32>
  ...
  vector.transfer_write %10, %3[%c0, %workgroup_id_x] {in_bounds = [true, true]} : vector<1x1xf32>, memref<1x3xf32, #hal.descriptor_type<storage_buffer>>
  return
}
