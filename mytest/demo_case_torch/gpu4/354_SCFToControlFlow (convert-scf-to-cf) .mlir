...
func.func @main_dispatch_0_matmul_1x3x4_f32() {
  ...
  %30 = vector.fma %14, %6, %28 : vector<1xf32>
  %31 = vector.fma %18, %8, %30 : vector<1xf32>
  %32 = vector.fma %21, %10, %31 : vector<1xf32>
  %33 = vector.fma %24, %12, %32 : vector<1xf32>
  %34 = vector.insert %33, %cst [0] : vector<1xf32> into vector<1x1xf32>
  %35 = arith.addf %34, %29 : vector<1x1xf32>
  %36 = vector.extract %35[0, 0] : f32 from vector<1x1xf32>
  memref.store %36, %3[%c0, %workgroup_id_x] : memref<1x3xf32, #gpu.address_space<global>>
  return
}
