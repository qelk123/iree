...
func.func @main_dispatch_0_matmul_1x3x4_f32() {
  ...
  %27 = memref.load %subview_3[%c0, %c0] : memref<1x1xf32, strided<[3, 1], offset: ?>, #gpu.address_space<global>>
  ...
  memref.store %44, %subview_4[%c0, %c0] : memref<1x1xf32, strided<[3, 1], offset: ?>, #gpu.address_space<global>>
  return
}
