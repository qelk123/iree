...
module {
  func.func @main_dispatch_0_matmul_1x3x4_f32() {
    ...
    %25 = memref.load %2[%c0, %workgroup_id_x] : memref<1x3xf32, strided<[3, 1], offset: 16>, #gpu.address_space<global>>
    %26 = vector.broadcast %25 : f32 to vector<1xf32>
    %27 = math.absf %24 : vector<1xf32>
    %28 = vector.fma %14, %6, %26 : vector<1xf32>
    %29 = vector.fma %17, %8, %28 : vector<1xf32>
    %30 = vector.fma %20, %10, %29 : vector<1xf32>
    %31 = vector.fma %23, %12, %30 : vector<1xf32>
    %32 = arith.addf %31, %27 : vector<1xf32>
    %33 = vector.extract %32[0] : f32 from vector<1xf32>
    memref.store %33, %3[%c0, %workgroup_id_x] : memref<1x3xf32, #gpu.address_space<global>>
    return
  }
}
