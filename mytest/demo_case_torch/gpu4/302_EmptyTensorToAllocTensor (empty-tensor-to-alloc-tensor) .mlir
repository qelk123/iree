...
module {
  func.func @main_dispatch_0_matmul_1x3x4_f32() {
    ...
    %13 = vector.contract {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d2)>, affine_map<(d0, d1, d2) -> (d2, d1)>, affine_map<(d0, d1, d2) -> (d0, d1)>], iterator_types = ["parallel", "parallel", "reduction"], kind = #vector.kind<add>} %7, %8, %11 : vector<1x4xf32>, vector<4x1xf32> into vector<1x1xf32>
